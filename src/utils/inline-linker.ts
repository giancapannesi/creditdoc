...
const MONEY_LINKS: MoneyLink[] = [
  ...
  { phrase: 'home equity loans', url: '/categories/mortgages/', title: 'Home Loans & Mortgages' },
  { phrase: 'home equity loan', url: '/categories/mortgages/', title: 'Home Loans & Mortgages' },
  ...
  { phrase: 'payday lending', url: '/best/best-payday-loan-alternatives/', title: 'Best Payday Loan Alternatives' },
  ...
  { phrase: 'short-term credit', url: '/categories/emergency-cash/', title: 'Short-Term Credit' },
  ...
  { phrase: 'credit access businesses', url: '/best/best-credit-repair-companies/', title: 'Best Credit Repair Companies' },
  { phrase: 'credit access', url: '/best/best-credit-repair-companies/', title: 'Best Credit Repair Companies' },
  ...
  // /answers/ pages — question-style links for city guides + editorial content
  { phrase: 'how to build credit', url: '/answers/how-to-build-credit-score-fast/', title: 'How to Build Credit Score Fast' },
  { phrase: 'build credit with no history', url: '/answers/build-credit-with-no-credit-history/', title: 'Build Credit With No History' },
  { phrase: 'build credit from scratch', url: '/answers/build-credit-with-no-credit-history/', title: 'Build Credit With No History' },
  { phrase: 'get a personal loan', url: '/answers/how-to-get-a-personal-loan/', title: 'How to Get a Personal Loan' },
  { phrase: 'qualify for a personal loan', url: '/answers/how-to-get-a-personal-loan/', title: 'How to Get a Personal Loan' },
  { phrase: 'personal loan interest rates', url: '/answers/personal-loan-interest-rates-explained/', title: 'Personal Loan Interest Rates Explained' },
  { phrase: 'how much can I borrow', url: '/answers/how-much-can-you-borrow-with-your-credit-score/', title: 'How Much Can You Borrow' },
  { phrase: 'credit score affects', url: '/answers/does-credit-score-affect-car-insurance/', title: 'Credit Score & Insurance' },
  { phrase: 'credit card interest', url: '/answers/how-credit-card-interest-works/', title: 'How Credit Card Interest Works' },
  { phrase: 'debt consolidation yourself', url: '/answers/can-i-do-debt-consolidation-myself/', title: 'DIY Debt Consolidation' },
  { phrase: 'do debt consolidation myself', url: '/answers/can-i-do-debt-consolidation-myself/', title: 'DIY Debt Consolidation' },
  { phrase: 'small business loan guide', url: '/answers/small-business-loans-guide/', title: 'Small Business Loans Guide' },
  { phrase: 'are small business loans worth it', url: '/answers/are-small-business-loans-worth-it/', title: 'Are Business Loans Worth It?' },
  { phrase: 'find the best personal loan', url: '/answers/how-to-find-best-personal-loan-lenders/', title: 'How to Find Best Lenders' },
  { phrase: 'easy approval credit cards', url: '/answers/easy-approval-credit-cards/', title: 'Easy Approval Credit Cards' },
  { phrase: 'car loan with my credit score', url: '/answers/can-i-get-a-car-loan-with-my-credit-score/', title: 'Car Loan by Credit Score' },
  // BNPL / fintech / consumer lending language
  { phrase: 'buy now pay later', url: '/categories/personal-loans/', title: 'Buy Now Pay Later & Loans' },
  { phrase: 'point-of-sale lending', url: '/categories/personal-loans/', title: 'Point-of-Sale Lending' },
  { phrase: 'point of sale lending', url: '/categories/personal-loans/', title: 'Point-of-Sale Lending' },
  { phrase: 'split payments', url: '/categories/personal-loans/', title: 'Installment & Split Payment Loans' },
  { phrase: 'pay over time', url: '/categories/personal-loans/', title: 'Pay Over Time Options' },
  { phrase: 'deferred interest', url: '/about/creditdoc-data/#pricing', title: 'Understanding Deferred Interest' },
  { phrase: 'soft credit check', url: '/answers/how-to-build-credit-score-fast/', title: 'Soft vs Hard Credit Checks' },
  { phrase: 'hard credit inquiry', url: '/answers/how-to-build-credit-score-fast/', title: 'Hard Credit Inquiries Explained' },
  { phrase: 'hard inquiry', url: '/answers/how-to-build-credit-score-fast/', title: 'Hard Inquiries Explained' },
  { phrase: 'hard pull', url: '/answers/how-to-build-credit-score-fast/', title: 'Hard Pulls Explained' },
  { phrase: 'build credit history', url: '/answers/build-credit-with-no-credit-history/', title: 'Build Credit History' },
  { phrase: 'credit history', url: '/answers/build-credit-with-no-credit-history/', title: 'Build Your Credit History' },
  { phrase: 'credit scores', url: '/tools/credit-score-simulator/', title: 'Credit Score Simulator' },
  { phrase: 'credit score', url: '/tools/credit-score-simulator/', title: 'Credit Score Simulator' },
  { phrase: 'thin credit file', url: '/answers/build-credit-with-no-credit-history/', title: 'Thin Credit File Solutions' },
  { phrase: 'thin credit', url: '/answers/build-credit-with-no-credit-history/', title: 'Thin Credit Solutions' },
  { phrase: 'no credit history', url: '/answers/build-credit-with-no-credit-history/', title: 'No Credit History Guide' },
  { phrase: 'late fees', url: '/about/creditdoc-data/#pricing', title: 'Understanding Late Fees' },
  { phrase: 'hidden fees', url: '/about/creditdoc-data/#pricing', title: 'Understanding Hidden Fees' },
  { phrase: 'annual percentage rate', url: '/answers/personal-loan-interest-rates-explained/', title: 'APR Explained' },
  { phrase: 'interest rates', url: '/answers/personal-loan-interest-rates-explained/', title: 'Interest Rates Explained' },
  { phrase: 'interest rate', url: '/answers/personal-loan-interest-rates-explained/', title: 'Interest Rates Explained' },
  { phrase: 'credit builder', url: '/best/best-credit-builder-loans/', title: 'Best Credit Builder Loans' },
  { phrase: 'secured card', url: '/best/best-secured-credit-cards/', title: 'Best Secured Credit Cards' },
  // /courses/ — educational content links
  { phrase: 'credit fundamentals course', url: '/courses/credit-fundamentals/', title: 'Credit Fundamentals Course' },
  { phrase: 'free credit course', url: '/courses/credit-fundamentals/', title: 'Credit Fundamentals Course' },
];
