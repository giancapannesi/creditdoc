...
const ARCHIVED_REVIEW_SLUGS = new Set([
  ...
  "atm-7eleven",
  "atm-casco-check-cashing",
  "atm-p-e-services-station-inc",
  "bookmans-westside-pawn",
  "first-choice-grocery-check-cashing-beer-wine",
  "gideon-diamonds",
  "ka-money-loan-pawn-brokers",
  "kashs-pawn-and-tool",
  "mid-west-title-loans",
  "mvp-cars-titles-loans",
  "myecon-coins-to-cruises",
  "nyu-wasserman-center-for-career-development",
  "one-of-one-pawnbroker",
  "orlando-jewelry-and-loan",
  "pawn212",
  "pawnshop-academy",
  "pawnsmart",
  "pay-commander-check-cashing-atm-kiosk",
  "rapid-car-title-pawns",
  "real-simple-car-loan",
  "s-s-jewelry-loan",
  "southern-states-title-pawn",
...
export function getAllLenders(): Lender[] {
  ...
  _lendersCache = files.map(f => {
    ...
    l.name = typeof l.name === 'string' ? normalizeLenderDisplayName(l.name) : l.name;
