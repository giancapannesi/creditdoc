# CreditDoc Regulatory Next Phase Scheduler - 2026-07-19 11:10 UTC
...
## Checks
### regulatory execution - FAIL
```
CreditDoc regulatory SEO execution check: status=WARN report=/srv/BusinessOps/creditdoc/reports/regulatory-refresh/regulatory_seo_execution_2026-07-19.md
```

### priority regulatory dry-run - OK
```
CreditDoc Priority Indexing — 2026-07-19 11:10 UTC
============================================================
  Tools:    0
  Courses:  0
  Research: 0
  ...
  Compare:  0
  State:    0
  (Skipped 3 already indexed (PASS), 0 unverified, 1 in tier-specific cooldown)

Total priority queue: 3 URLs

--- DRY RUN — top 10 ---
  [regulatory] https://www.creditdoc.co/editorial-policy/
  [regulatory] https://www.creditdoc.co/about/harvey-brooks/
  [regulatory] https://www.creditdoc.co/about/
```
