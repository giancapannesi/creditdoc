# CreditDoc Regulatory Next Phase Scheduler - 2026-07-11 11:10 UTC

## Indexing Queue
- Priority regulatory/money/tool URLs tracked: 23
- Newly added to force-Google queue: 15
- Force-Google queue size after merge: 36

## Checks
### regulatory execution - OK
```
CreditDoc regulatory SEO execution check: status=PASS report=/srv/BusinessOps/creditdoc/reports/regulatory-refresh/regulatory_seo_execution_2026-07-11.md
```

### priority regulatory dry-run - OK
```
CreditDoc Priority Indexing — 2026-07-11 11:10 UTC
============================================================
  Tools:    0
  Courses:  0
  Research: 0
